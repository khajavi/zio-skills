...
object HelloWorldStreaming extends ZIOAppDefault {
  ...
  val routes: Routes[Any, Response] = Routes(
    ...
    // SSE streaming endpoint - pushes HTML updates
  ...
  def indexPage = html(
    head(
      ...
      title("Datastar Hello World - ZIO HTTP"),
      datastarScript,
      style.inlineCss(css),
    ),
    body(
      // dataInit auto-triggers the SSE endpoint on page load
