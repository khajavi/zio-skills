# tinyoptics Documentation Website

This directory contains the Docusaurus documentation site for tinyoptics.
...
- **docs/references/optics-api.md** — API reference documentation
