---
name: module-ref-checklist
description: The review checklist a ZIO module reference must pass before it is considered done. Load when reviewing a finished module reference for the module narrative, layout correctness, type coverage, and examples.
---
...
`references/checklist.md`). Verify every item before considering a module reference done.
