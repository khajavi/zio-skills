---
name: data-type-ref-checklist
description: The review checklist a ZIO data type reference page must pass before it is considered done. Load when reviewing a finished reference page for structure, API coverage, technical accuracy, and examples.
---
