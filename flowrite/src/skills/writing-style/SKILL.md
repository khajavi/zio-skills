...
Apply these rules to every documentation page you write or edit.
...
8. **Always qualify method/constructor names**:
   ...
   Dot-prefixed references (`` `.method` ``) are always a violation — they imply a receiver without naming it.
...
16. **Always include imports**: Every code block starts with the necessary import statements.
...
19. **Show method signatures within their containing type**, not as bare signatures:
...
25. **Use the `@VERSION@` placeholder for versions**:
