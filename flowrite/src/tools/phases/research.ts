    ...
    return {
      output: await researchSubject({
        ...
        prompt: [
          ...
          ``,
          `Then mine the repo's history for WHY the type is shaped this way — read the commit history`,
          `of the files you read, follow the PRs and issues those commits name, and record what you`,
          `find in "designRationale". Source and tests say what the type does; only history says what`,
          `it was weighed against. Return an empty array if history says nothing about this type.`,
        ],
      }),
    };
  },
    ...
    return {
      output: await researchSubject({
        ...
        prompt: [
          ...
          ``,
          `Then mine the repo's history for WHY the module is factored this way — read the commit`,
          `history of the files you read, follow the PRs and issues those commits name, and record what`,
          `you find in "designRationale". Module-level rationale (why these types are separate, why one wraps`,
    ...
    return {
      output: await researchSubject({
        ...
        prompt: [
          ...
          `"sourceFiles". Never guess a path or line — cite only a file you opened.`,
          ``,
          `Then mine the repo's history for WHY the concept works this way — read the commit history of`,
          `the files you read, follow the PRs and issues those commits name, and record what you find in`,
