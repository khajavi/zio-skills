 ...
 * actions/subagents of its own — see tutorial-designer's former note: delegating
 * to a narrow profile (instead of reopening a session on the calling agent)
 * means it cannot see or re-invoke the design action itself, avoiding runaway
 * self-recursion.
 *
